...
+ (NSArray *)routes
{
  ...
  @[
    ...
    [[FBRoute POST:@"/wda/tapx"] respondWithTarget:self action:@selector(handleDeviceTap:)],
    [[FBRoute POST:@"/wda/tapx"].withoutSession respondWithTarget:self action:@selector(handleDeviceTap:)],
    [[FBRoute POST:@"/wda/swipex"] respondWithTarget:self action:@selector(handleDeviceSwipe:)],
    [[FBRoute POST:@"/wda/swipex"].withoutSession respondWithTarget:self action:@selector(handleDeviceSwipe:)],
